...
class ProjectAttributesTestCase(TestCase):
    ...
    def setUp(self):
        ...
        boolean_project_attribute_key = \
            models.ProjectAttributeKey.objects.create(
                name="NAME1",
                display_name="DISPLAYNAME",
                data_type="BOOLEAN",
            )
        self.boolean_project_attribute = \
            models.ProjectAttribute.objects.create(
                project=project,
                key=boolean_project_attribute_key,
                boolean_value=True,
            )

        char_project_attribute_key = \
            models.ProjectAttributeKey.objects.create(
                name="NAME2",
                display_name="DISPLAYNAME",
                data_type="CHAR",
            )
        self.char_project_attribute = \
            models.ProjectAttribute.objects.create(
                project=project,
        ...
        datetime_project_attribute_key = \
            models.ProjectAttributeKey.objects.create(
                name="NAME4",
                display_name="DISPLAYNAME",
                data_type="DATETIME",
            )
        self.datetime_project_attribute = \
            models.ProjectAttribute.objects.create(
                project=project,
        ...
        integer_project_attribute_key = \
            models.ProjectAttributeKey.objects.create(
                name="NAME6",
                display_name="DISPLAYNAME",
                data_type="INTEGER",
            )
        self.integer_project_attribute = \
            models.ProjectAttribute.objects.create(
                project=project,
    ...
    def test_values(self):
        assert self.boolean_project_attribute.value() is True
